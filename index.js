showTodos();
      ...
      <li id="todo-${index}" class="todo">
        ...
        <div
          ...
          <button
            ...
            <i class='far fa-trash-alt fa-2x' style='color:#ffffff'></i>
          </button>
        <button
          id="edit-todo-btn-${index}"
          class="edit-todo-btn"
          onclick="editTodo(${index})">
          <i class='far fa-edit fa-2x' style='color:#ffffff'></i>
        </button>
      </li>
    `
			});
    ...
    function editTodo(index) {
      ...
      <i class='far fa-check-circle fa-2x' style='color:#ffffff'></i>`;
